  ...
  <div>
    ...
    <div v-if="canManageUsers" class="bg-base-100 rounded-2xl shadow-xl border border-base-300/50 overflow-hidden">
      <div class="p-8">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <div>
            <h2 class="text-3xl font-bold mb-2 bg-linear-to-r from-primary to-secondary bg-clip-text text-transparent">All Users</h2>
        ...
        <div class="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <select v-model="roleFilter" class="select select-bordered w-full sm:w-48">
        ...
        <div v-else-if="filteredUsers.length > 0" class="overflow-x-auto -mx-8">
          <table class="table">
            ...
            <tbody>
              <tr v-for="u in filteredUsers" :key="u.id" class="hover:bg-base-200/30 transition-colors border-b border-base-200/50">
    ...
    <div v-else class="bg-base-100 rounded-2xl shadow-xl border border-base-300/50 overflow-hidden">
      <div class="text-center py-20 px-8">
        ...
        <p class="text-base-content/60 mb-8 max-w-md mx-auto">You don't have permission to view users. Contact your administrator for access.</p>
